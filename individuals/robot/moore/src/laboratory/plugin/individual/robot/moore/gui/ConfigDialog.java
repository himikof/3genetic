package laboratory.plugin.individual.robot.moore.gui;
...
import laboratory.plugin.individual.robot.moore.Config;
...
public class ConfigDialog extends JDialog {
    ...
    public ConfigDialog(JFrame owner, final Properties p, final AbstractIndividualLoader<MooreAutomaton> l) {
    ...
    private void showOperatorChooserDialog(Properties p, AbstractIndividualLoader<MooreAutomaton> l) {
