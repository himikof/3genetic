package laboratory.core.gui.panel;
...
public class GraphicPanel extends JPanel {
    ...
    public GraphicPanel(ArrayList<ArrayList<Double>> values, List<String> names) {
        ...
        this.values = values;
        this.names = names;
        ChartPanel chartPanel = new ChartPanel(createChart(createDataset(values)), false);
    ...
    private static JFreeChart createChart(XYDataset dataset) {
        ...
        BasicStroke stroke = new BasicStroke(InterfaceConfig.GRAPHIC_FRAME_PROPERTIES.getInt("line-width"));
        for (int i = 0; i < 5; i++) {
